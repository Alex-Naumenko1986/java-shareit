...
public class ItemControllerTest {
    ...
    @SneakyThrows
    @Test
    void createItem_shouldThrowExceptionWhenCreateItemWithInvalidName() {
        itemDto.setName(" ");
    ...
    @SneakyThrows
    @Test
    void createItem_shouldThrowExceptionWhenCreateItemWithInvalidDescription() {
    ...
    @SneakyThrows
    @Test
    void createItem_shouldThrowExceptionWhenCreateItemWithInvalidAvailable() {
    ...
    void searchItems_shouldReturnItem() {
        ...
        mockMvc
                .perform(
                        MockMvcRequestBuilders.get("/items/search?text=item")
                                .header("X-Sharer-User-Id", 1))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(
    ...
    @SneakyThrows
    @Test
    void addComment_shouldThrowExceptionWhenAddInvalidComment() {
